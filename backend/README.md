...
## Project Structure
    ...
    ├── quiet_mouse_dev_102229  # Django project configurations
...
1. Clone this repo and `cd quiet_mouse_dev_102229`
...
2. Clone this repo and `cd quiet_mouse_dev_102229`
