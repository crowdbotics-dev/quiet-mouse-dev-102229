"""
Django settings for quiet_mouse_dev_102229 project.
...
ROOT_URLCONF = 'quiet_mouse_dev_102229.urls'
...
WSGI_APPLICATION = 'quiet_mouse_dev_102229.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "quiet_mouse_dev_102229 API",
    "DESCRIPTION": "API documentation for quiet_mouse_dev_102229 App",
    "VERSION": "v1",
}
